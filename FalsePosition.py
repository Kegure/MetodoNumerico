...
class FalsePosition:
    ...
    def false_Position_Formula(self, x, y):
        return ((x * self.func(y)) - (y * self.func(y))) / (self.func(y) - self.func(x))
    ...
    def calculus(self):
        ...
        for i in range(self.max_Iterations):
            ...
            if self.func(x) * self.func(z) < 0:
                ...
                x = z
        raise ValueError("Numero Maximo de iteraçoes atingida, sem solução ou aumentar o tamanho das interacoes")
